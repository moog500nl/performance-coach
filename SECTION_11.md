...
| Aggregate Durability (7d)    | <3% good / 3–5% moderate / >5% declining           | 7d mean > 28d mean by >2%         | 28d mean > 5% sustained (requires ≥ 5 qualifying sessions) | Mean decoupling from steady-state sessions (VI ≤ 1.05, ≥ 60min). 28d mean suppressed when N < 5 — insufficient_sample_28d flag set, info alert emitted instead of alarm. |
